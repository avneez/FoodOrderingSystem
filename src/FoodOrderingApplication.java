...
public class FoodOrderingApplication {
    ...
    public static void main(String[] args) {
        ...
        restaurantService.addItemsInCatalog("Donald", "Burger", 250.0, 2);
        restaurantService.addItemsInCatalog("Donald", "Pizza", 500.0, 10);
        restaurantService.addItemsInCatalog("Avneez", "Pasta", 500.0, 10);
        ...
        long orderId1 = orderService.placeOrder(userId, "Donald", "Sandwich", 2, "SAVE10");
        System.out.println();
        System.out.println("Order placed successfully orderId: " + orderId1);

        long orderId2 = orderService.placeOrder(userId, "Donald", "Pizza", 1);
        System.out.println();
        System.out.println("Order placed successfully orderId: " + orderId2);
        orderService.cancelOrder(orderId2);

        long orderId3 = orderService.placeOrder(userId,"Avneez", "Pasta", 2);
        System.out.println();
        System.out.println("Order placed successfully orderId: " + orderId3);
    ...
    private static void printOrders(OrderService orderService, long userId) {
        ...
        System.out.println("orderId, item, quantity, status, discountPercentage, finalPrice");
